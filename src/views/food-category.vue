	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="card card-stats">
			<div class="card-header card-header-sucess card-header-icon">
				...
				<h3 class="card-title" style="float: left; "> <b> Food Categorys</b> </h3>
			</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-6">
											<form>
												<div class="form-group">
													<label style="font-size:15px; width: 260px; color: black;font-style:bold;" for="Name">Enter Category Name </label>
...
export default {
	...
	methods: {
		showForm(formType) {
			...
			if (formType == "add") {
				this.formTitle = "Add Food Categorys";
				this.actionType = formType;
			} else {
				this.formTitle = "Update Food Categorys";
				this.actionType = formType;
			}
		}
	}
